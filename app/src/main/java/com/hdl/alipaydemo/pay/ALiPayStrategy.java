    ...
    public void pay(final Activity context, final String orderInfo, PayCallback callback) {
        ...
        new Thread() {//支付过程必须在子线程中发起
            ...
            public void run() {
                ...
                if ("9000".equals(payResultForALiPay.getResultStatus()) && "10000".equals(payResultForALiPay.getResult().getAlipay_trade_app_pay_response().getCode())) {//沙箱环境的结果码
